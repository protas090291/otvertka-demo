...
def create_final_signature_letter():
    ...
    document_data = {
        'apartment_id': '2401',
        'apartment_number': '2401',
        'issue_type': 'смещение сроков отделочных работ',
        'issue_description': 'задержка в выполнении отделочных работ в квартире 2401 из-за несоответствия качества материалов, что влияет на общие сроки сдачи объекта',
        'expected_resolution': 'Замена материалов и ускорение отделочных работ',
